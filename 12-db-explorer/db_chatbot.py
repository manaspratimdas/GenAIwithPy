...
system_prompt = (
    ...
    "don't know. Ensure that answwr is complete and in detail."
    "\n\n"
    "{context}"
)
...
retriver_chain.invoke({
    "chat_history": [HumanMessage(content="what is the database about")],
    "question": "list the tables on datbase?"
